...
public class DefaultProgram {
	...
	public void go(int i) {
		...
		factories.add(new IntegerConstantFactory(1, 30)); //12,60,1 and the target number
		double num = 60;
...
//						  karvaEvaluator.print(bestIndividual));    
					...
					try{
						...
						String fileName = "D:\\GEP output " + i + "\\Target_"+ num +"_pop_100_Iteration_1000_opr_mult"+".txt";
				...
				String fileName = "D:\\GEP output "+ i +"\\Gen" + data.getGenerationNumber() + ".csv";
				try{
		...
		engine.evolve(100, 1, new TargetFitness(0, false));
