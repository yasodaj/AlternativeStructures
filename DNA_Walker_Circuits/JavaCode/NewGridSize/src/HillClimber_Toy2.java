...
public class HillClimber_Toy2 {
	
	public static String saveDirectoryParent = "E:\\HillClimber\\NewGridSize\\Toy2\\";
	private static String saveDirectory = "E:\\HillClimber\\NewGridSize\\Toy2\\";
	...
	private static int numberOfNodes = 9;	
	...
	public static void main(String args[]) throws Exception {
		...
		populateNodeIdentifierToy2();
		populateNodeConnectionIdentifierToy2();
		populateNodeBranchRelationshipToy2();
...
//		createFitnessStore(fitnessFileName);
		...
		for(int n = 8; n <= 8; n++) {
			...
			runHillClimber_Toy2(n);
			
		}
		
//		printSolution(generateRandomSolutionMaster());
		
	}
	
	public static void runHillClimber_Toy2(int iteration) throws Exception {
...
//	}
	...
	public static void populateNodeConnectionIdentifierToy2() {
		...
		nodeConnectionIdentifier.put(new int[] {2,3},"Fork-Norm11");
		nodeConnectionIdentifier.put(new int[] {2,5},"Fork-Norm21");
		nodeConnectionIdentifier.put(new int[] {3,4},"Norm11-Norm12");
		nodeConnectionIdentifier.put(new int[] {5,6},"Norm21-Norm22");
		nodeConnectionIdentifier.put(new int[] {4,7},"Norm12-Final1");
		nodeConnectionIdentifier.put(new int[] {6,8},"Norm22-Final2");
		
		
	}
	
	public static void populateNodeIdentifierToy2() {
		...
		nodeIdentifier.put(Integer.valueOf(6),"Norm");
		nodeIdentifier.put(Integer.valueOf(7),"Final");
		nodeIdentifier.put(Integer.valueOf(8),"Final");
	...
	public static void populateNodeBranchRelationshipToy2() {
		...
		nodeBranchRelationship.put(Integer.valueOf(7),Integer.valueOf(1));
		nodeBranchRelationship.put(Integer.valueOf(8),Integer.valueOf(2));	
