...
public class HillClimber_Toy0 {
	public static String saveDirectoryParent = "E:\\HillClimber\\NewGridSize\\Toy0\\";
	private static String saveDirectory = "E:\\HillClimber\\NewGridSize\\Toy0\\";
	...
	private static double iter = 40000;
	//Convergence point
	...
	public static void main(String args[]) throws Exception{
		...
		populateNodeIdentifierToy0(); // load node labels for the layout
		populateNodeConnectionIdentifierToy0(); // load node connections 
		populateNodeBranchRelationshipToy0(); //load node branch connection
		
//		String fitnessFileName = "E:\\TestDavidSolutions\\OldGridSize\\Toy0\\Solutions_toy0"
...
//		createFitnessStore(fitnessFileName);
	...
	public static void runHillClimberToy0(int iteration) throws Exception {
...
//	    printSolution(solution);
	...
	public static int[] smallChangeMaster(int[] solution) {
		...
		do {
			...
			selection = generateRandomInt(1,4);
...
//			System.out.println();
	...
	public static String generateMarcieCoordinateStringToy0(int[] coordinates) {
		...
		String format2 = "(x=%d & y=%d & z=NORM & w=E) |\n"; //norm 0
...
//		String[] coordinateArray = coordinateString.split(",");
	...
	public static void writeToFile(int[] sol, boolean isValid) {
		...
		try {
			String logFilename = "E:\\TestDavidSolutions\\Toy0\\TestMyValidFunction.txt";
			FileWriter fw = new FileWriter(logFilename, true); // the true will append the new data
