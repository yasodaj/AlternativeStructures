...
public class RMSDDistanceMeasure {
	...
	private static String saveDirectory = "E:\\LayoutComparison\\Toy\\RMSDWithRotation\\NewSample_NewGridSize_WithAlternativeSolutions_5k_Run9\\";
	...
	public static void main(String args[]) {
		...
		for(int a = 1; a <= 1; a++) {
			...
			solutionFile = saveDirectory + "Run9_uniqueElite.txt";
			rmsdOutput = saveDirectory + "Run9_uniqueElite_PairWiseDistance.txt";
			
			
//			solutionFile = saveDirectory + "Sample" + a + "\\" + "Toy_Sample_" + a + ".txt";
//			rmsdOutput = saveDirectory + "Sample" + a + "\\" + "PairwiseRMSD_ToySample_" + a + ".txt";
